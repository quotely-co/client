    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white py-12">
      <div className="max-w-3xl mx-auto px-4">
        ...
        <div className="section-heading mb-12">
          ...
          <p className="section-description  text-sm">How can your customers reach you?</p>
        </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onBlur={() => setFocused("")}
                    className={` pl-12 pr-4 py-3 border rounded-lg transition-all focus:ring-2 focus:ring-black focus:border-transparent ${focused === "email" ? "border-black" : "border-gray-200"
                      }`}
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onBlur={() => setFocused("")}
                    className={` pl-12 pr-4 py-3 border rounded-lg transition-all focus:ring-2 focus:ring-black focus:border-transparent ${focused === "phone" ? "border-black" : "border-gray-200"
                      }`}
